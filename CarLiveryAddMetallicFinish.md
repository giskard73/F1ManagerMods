...
1. Create a mask for the parts of the livery you don't want to be metallic, then add black fill layer on the bottom. All parts masked in black will be paint finish. You can then adjust roughness by editing `Livery_mask.tga`, Roughness is on the Green channel.
